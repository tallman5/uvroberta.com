...
const Header = () => {
    ...
    return (
        <nav className="navbar fixed-top bg-body-secondary navbar-expand-md">
            <div className="container">
                ...
                <div style={{ justifyContent: 'space-between' }} className={(navMenuVisible === true) ? 'collapse navbar-collapse show' : 'collapse navbar-collapse'} id="navbarNavAltMarkup">
                    <div className={'navbar-nav'}>
                        <Link className={(pathname.startsWith('/pilot')) ? 'nav-link active' : 'nav-link'} to="/pilot">PILOT</Link>
                        <Authorize requireRole='roberta.admins'>
